...
static const char *const errorNames[] = {ERROR_NAME(asSUCCESS), ERROR_NAME(asERROR), ERROR_NAME(asCONTEXT_ACTIVE), ERROR_NAME(asCONTEXT_NOT_FINISHED), ERROR_NAME(asCONTEXT_NOT_PREPARED), ERROR_NAME(asINVALID_ARG), ERROR_NAME(asNO_FUNCTION),
                                         ERROR_NAME(asNOT_SUPPORTED), ERROR_NAME(asINVALID_NAME), ERROR_NAME(asNAME_TAKEN), ERROR_NAME(asINVALID_DECLARATION), ERROR_NAME(asINVALID_OBJECT), ERROR_NAME(asINVALID_TYPE),
                                         ERROR_NAME(asALREADY_REGISTERED), ERROR_NAME(asMULTIPLE_FUNCTIONS), ERROR_NAME(asNO_MODULE), ERROR_NAME(asNO_GLOBAL_VAR), ERROR_NAME(asINVALID_CONFIGURATION), ERROR_NAME(asINVALID_INTERFACE),
                                         ERROR_NAME(asCANT_BIND_ALL_FUNCTIONS), ERROR_NAME(asLOWER_ARRAY_DIMENSION_NOT_REGISTERED), ERROR_NAME(asWRONG_CONFIG_GROUP), ERROR_NAME(asCONFIG_GROUP_IS_IN_USE),
                                         ERROR_NAME(asILLEGAL_BEHAVIOUR_FOR_TYPE), ERROR_NAME(asWRONG_CALLING_CONV), ERROR_NAME(asBUILD_IN_PROGRESS), ERROR_NAME(asINIT_GLOBAL_VARS_FAILED), ERROR_NAME(asOUT_OF_MEMORY),
