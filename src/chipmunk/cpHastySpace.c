...
typedef struct {int dumbComplier;} pthread_condattr_t; // Dummy;
...
typedef struct {int dumbComplier;} pthread_mutexattr_t; //< Dummy
...
typedef struct {int dumbComplier;} pthread_attr_t;
...
static void RunWorkers(cpHastySpace *hasty, cpHastySpaceWorkFunction func)
{
